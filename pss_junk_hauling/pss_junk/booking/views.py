...
"Great! I've logged your appointment request. Our team will call you at [phone] to confirm. You can also reach us directly at {BUSINESS_PHONE}."
...
- Keep messages SHORT and conversational — don't dump everything at once
...
""".replace("{BUSINESS_PHONE}", settings.BUSINESS_PHONE)
...
def chat(request):
    ...
    try:
        ...
        return JsonResponse({'reply': f'Sorry, something went wrong. Please call us at {settings.BUSINESS_PHONE}', 'session_key': session_key}, status=200)
